...
- **Limitations:** re-root ("focus") on double-click rather than in-place node expansion; SVG radial (no d3-force physics); no minimap; Neural tab is a placeholder (F5); no analytics (F6). No new deps.
